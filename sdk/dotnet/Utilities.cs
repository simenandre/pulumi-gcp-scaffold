...
namespace Pulumi.Gcp-scaffold
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Gcp-scaffold.version.txt");
    ...
    internal sealed class Gcp-scaffoldResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Gcp-scaffoldResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
